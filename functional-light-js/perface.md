...
但是，为什么学习函数式编程，甚至是轻型编程对你来说如此重要？ 
近年来，我开始非常深信，所以你几乎可以称之为宗教信仰。 
我认为编程基本上是关于人类，而不是代码。 我认为代码首先是人类交流的一种手段，
只是作为一种副作用（听到我的自我指责的笑声）它才能指导计算机。 
我认为，函数式编程的核心是在代码中使用众所周知，可理解的模式，并证明可以避免使代码难以理解的错误。
 在那个观点中，FP - 或者，哼，FLP！ - 可能是任何开发人员可以获得的最重要的工具集合之一。

> The curse of the monad is that... once you understand... you lose the ability to explain it to anyone else.
> monad的诅咒就是......一旦你理解了......你就失去了向其他人解释它的能力。
> 
